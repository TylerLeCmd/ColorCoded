...
function Screen(lev) {
  ...
  if (lev == 0) {
    ...
    plat[0] = new Platform(boardLeft + 455, boardGround - 336.5, 150, 50)
    plat[0].display();
    plat[1] = new Platform(boardLeft + 150, boardGround - 136.5, 150, 50)
    plat[1].display();
    plat[2] = new Platform(boardLeft + 820, boardGround - 550.5, 150, 50)
    plat[2].display();
    this.shiftZone("UP");
    ...
    plat[0] = new Platform(boardLeft + 580, boardGround - 80.5, 150, 50)
    plat[0].display();
    plat[1] = new Platform(boardRight - 170, boardGround - 186.5, 150, 50)
    plat[1].display();
    plat[2] = new Platform(boardLeft + 920, boardGround - 440.5, 150, 50)
    plat[2].display();
    plat[3] = new Platform(boardLeft + 500, boardTop + 150.5, 150, 50)
    plat[3].display();
    this.shiftZone("UP");
    for (var i = 0; i < this.plat.length; i++) {
      dist[i] = plat[i].distance();
    ...
    plat[0] = new Platform(boardLeft + 250, boardGround - 60.5, 150, 50)
    plat[0].display();
    plat[1] = new Platform(boardRight - 450, boardGround - 186.5, 150, 50)
    plat[1].display();
    plat[2] = new Platform(boardLeft + 300, boardGround - 400.5, 150, 50)
    plat[2].display();
    plat[3] = new Platform(boardRight - 450, boardTop + 150.5, 150, 50)
    plat[3].display();
    this.shiftZone("UP");
    for (var i = 0; i < this.plat.length; i++) {
      dist[i] = plat[i].distance();
    ...
    image(arrow, boardRight - 150, boardTop + 100, 50, 50)
    plat[0] = new Platform(boardRight - 75, boardGround - 60.5, 150, 50)
    plat[0].display();
    plat[1] = new Platform(boardRight - 150, boardGround - 300.5, 150, 50)
    plat[1].display();
    plat[2] = new Platform(boardLeft + 300, boardGround - 400.5, 150, 50)
    plat[2].display();
    plat[3] = new Platform(boardRight - 450, boardTop + 150.5, 150, 50)
